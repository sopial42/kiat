...
Read `delivery/epic-X/story-NN.md` end to end. Extract: acceptance criteria, component tree, user flows, edge cases, E2E scenarios. Ask Team Lead for clarification in chat if anything is unclear — do NOT guess.
