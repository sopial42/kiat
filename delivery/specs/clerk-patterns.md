...
### Mode 2: Test Auth Bypass (`make dev-test`)
...
- **Two dev modes** (`make dev` real auth, `make dev-test` bypass) — pick the right one for your task. Venom tests run against `make dev-test`; Playwright E2E needs `make dev`.
