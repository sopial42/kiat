...
- **One PR per story.** A story that requires 2 PRs means the story is too large — ask `kiat-tech-spec-writer` to split it at Stage 3 validation.
...
- **No merging without reviewer approval.** See `.claude/agents/kiat-team-lead.md` Stage 5.1 for the 3-way verdict protocol.
